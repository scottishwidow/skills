...
- **[reconcile-docs](./reconcile-docs/SKILL.md)** — Audit Markdown docs (ADRs, PRDs, `CONTEXT.md`, `AGENTS.md`) for conflicts, staleness, and source-of-truth drift; validates claims against the codebase. Maintenance bookend to `grill-with-docs`.
